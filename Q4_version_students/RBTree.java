...
public class RBTree<T extends Comparable<T>> {
	...
	public boolean testProp3() {
		...
		searchProp(root, heights, 0);
		return heights.size() <= 1;
		// END YOUR CODE
	}

	public void searchProp(Node<T> root, Set<Integer> heights, int current_height) {
		// NIL
		if (root.value == null) {
			current_height += 1;
			...
			searchProp(root.left, heights, current_height);
			searchProp(root.right, heights, current_height);
		}
	}
